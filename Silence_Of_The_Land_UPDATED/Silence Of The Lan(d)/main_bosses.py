...
# this class is for the large enemies in the game
...
class Main:
   def __init__(self, x, y, number):
       ...
       self.y = y
       if number == 1:
           self.image_list = ["big1.gif"]
       if number == 2:
           self.image_list = ["big2.gif"]
       if number == 3:
           self.image_list = ["big3.gif"]
       if number == 4:
           self.image_list = ["big4.gif"]
       if number == 5:
        self.image_list = ["big5.gif"]
   ...
   def go_to_player(self, player):
       if self.x == -10000 and self.y == -10000:
           ...
           self.rect.x += dir_x * 0.9
           self.rect.y += dir_y * 0.9
